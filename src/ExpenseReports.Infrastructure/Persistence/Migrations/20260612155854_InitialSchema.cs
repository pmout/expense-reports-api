        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyExpenseLimit = table.Column<decimal>(type: "numeric(12,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_expenses_TenantId_EmployeeId_Status_ExpenseDate",
                table: "expenses",
                columns: new[] { "TenantId", "EmployeeId", "Status", "ExpenseDate" });
